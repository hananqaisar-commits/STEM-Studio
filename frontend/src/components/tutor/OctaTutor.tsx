...
import { OctaTutorSettingsModal } from './OctaTutorSettingsModal';
...
export const OctaTutor: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className="tutor-header">
          ...
          <div className="tutor-header-actions">
            <button
              ...
              title="Configure Custom AI Model / API Key (BYOK)"
              aria-label="Configure Custom AI Model / API Key"
            >
              <Settings size={15} />
            </button>
            <button
      ...
      {/* Settings Modal (BYOK Custom LLM configuration) */}
      <OctaTutorSettingsModal
        isOpen={isSettingsOpen}
        onClose={() => setIsSettingsOpen(false)}
        config={llmConfig}
        onSaveConfig={saveLLMConfig}
        onResetDefault={resetLLMConfig}
      />
    </>
  );
};
